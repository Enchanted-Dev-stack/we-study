...
export default function Navbar() {
  ...
  const navigation = [
    ...
    { name: 'Study Materials', href: '/study-materials', current: false },
    { name: 'Flashcards', href: '/flashcards', current: false },
    { name: 'Quizzes', href: '/quizzes', current: false },
  ];
            ...
            <div className="flex h-16 justify-between">
              <div className="flex">
                <div className="flex flex-shrink-0 items-center">
                  <span className="text-2xl font-bold text-indigo-600">WeStudy</span>
                </div>
